...
class _HomeScreenState extends State<HomeScreen> {
        ...
        title: Row(
          children: [
            ...
            Text(
              'Location Access',
              style: TextStyle(
                  color: t.themeData.brightness == Brightness.light ? t.textPrimary : Colors.white),
            ),
          ],
        ),
        content: Text(
          ...
          style: TextStyle(
              color: t.themeData.brightness == Brightness.light ? t.textSecondary : Colors.white70),
        ),
        actions: [
          TextButton(
  ...
  Widget _buildPortraitContent(
      WeatherData weather, DailyForecast? today, bool isRefreshing) {
    ...
    return RefreshIndicator(
      ...
      child: CustomScrollView(
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: CurrentWeatherDisplay(
                ...
                temperatureMax:
                    today?.temperatureMax ?? weather.current.temperature,
                temperatureMin:
                    today?.temperatureMin ?? weather.current.temperature,
              ),
          ...
          SliverToBoxAdapter(
            child: ClothingAdviceCard(weather: weather).animate().fadeIn(
                duration: 600.ms,
                delay: 100.ms),
          ),
          ...
          SliverToBoxAdapter(
            child: RainTimelineCard(hourly: weather.hourly).animate().fadeIn(
                duration: 600.ms,
                delay: 150.ms),
          ),
          ...
          if (today != null)
            SliverToBoxAdapter(
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16),
                child: SunriseSunsetCard(today: today).animate().fadeIn(
                    duration: 600.ms,
                    delay: 200.ms),
              ),
            ),
          ...
          child: RefreshIndicator(
            ...
            child: CustomScrollView(
              ...
              slivers: [
                ...
                // Clothing advice
                SliverToBoxAdapter(
                  child: ClothingAdviceCard(weather: weather),
                ),
                const SliverToBoxAdapter(child: SizedBox(height: 16)),
  ...
  List<Widget> _buildForecastSlivers(
      WeatherData weather, DailyForecast? today) {
    final themeProvider = context.watch<ThemeProvider>();

    return [
      // Hourly forecast
      SliverToBoxAdapter(
        child: HourlyForecastCard(hourly: weather.hourly).animate().fadeIn(
            duration: 600.ms,
            delay: 200.ms)
          .slideY(
              begin: 0.03,
      ...
      // Daily forecast
      SliverToBoxAdapter(
        child: DailyForecastCard(daily: weather.daily).animate().fadeIn(
            duration: 600.ms,
            delay: 350.ms)
          .slideY(
              begin: 0.03,
      ...
      // Weather insights
      SliverToBoxAdapter(
        child: WeatherInsightsCard(weather: weather).animate().fadeIn(
            duration: 600.ms,
            delay: 425.ms)
          .slideY(
              begin: 0.03,
      ...
      Consumer<SettingsProvider>(
        builder: (context, settings, _) {
          ...
          return SliverToBoxAdapter(
            ...
            ).animate().fadeIn(duration: 600.ms, delay: 650.ms).slideY(
                begin: 0.03,
                end: 0,
                duration: 500.ms,
                curve: Curves.easeOut),
          ...
          children: [
            ...
            ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(
                ...
                shape: RoundedRectangleBorder(
                    borderRadius:
                        BorderRadius.circular(t.cardBorderRadius)),
              ),
            ),
          ],
        ),
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(t.cardBorderRadius),
          side: BorderSide(
              color: t.dangerColor.withValues(alpha: 0.4)),
        ),
        title: Text(
          'Remove location?',
        ...
        actions: [
          ...
          TextButton(
            ...
            child: Text('Remove',
                style: TextStyle(color: t.dangerColor)),
          ),
        ],
      ),
    );
