...
class _SettingsScreenState extends State<SettingsScreen> {
        ...
        return ThemedBackground(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Text(
                'Settings',
                style: TextStyle(shadows: t.textShadows),
              ),
              leading: IconButton(
  ...
  List<Widget> _buildControlsSection(SettingsProvider settings, AppThemeData t) {
    return [
      // Temperature unit
      ThemedCard(
        child: Column(
  ...
  List<Widget> _buildDeveloperSection(SettingsProvider settings, AppThemeData t) {
...
class _ThemePreviewCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final (String label, List<Color> colors, IconData icon) = switch (type) {
      AppThemeType.clean => (
          'Clean',
          [const Color(0xFF1A2340), const Color(0xFF2D3561), const Color(0xFF4B6CB7)],
          Icons.water_drop_rounded,
        ),
      AppThemeType.cyberpunk => (
          'Cyber',
          [const Color(0xFF0a0a1a), const Color(0xFF00e5ff), const Color(0xFFff2a6d)],
          Icons.bolt_rounded,
        ),
      AppThemeType.pastel => (
          'Pastel',
      ...
      AppThemeType.pastelDark => (
          'Pastel Dark',
          [const Color(0xFF1A1525), const Color(0xFF7B5EAE), const Color(0xFFCBB8F0)],
          Icons.nightlight_round,
        ),
      AppThemeType.sunset => (
          'Sunset',
          [const Color(0xFF1A1018), const Color(0xFFFF8A50), const Color(0xFFFF6B8A)],
          Icons.wb_twilight_rounded,
        ),
      AppThemeType.ocean => (
          'Ocean',
          [const Color(0xFF0A1520), const Color(0xFF00BFA5), const Color(0xFF40C4FF)],
          Icons.waves_rounded,
        ),
    };
      ...
      child: AnimatedContainer(
        ...
        child: Column(
          children: [
            ...
            Icon(icon, size: 18, color: isSelected ? t.accentColor : t.textSecondary),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: t.warningColor.withValues(alpha: 0.3),
          ),
        ),
        child: Row(
          children: [
