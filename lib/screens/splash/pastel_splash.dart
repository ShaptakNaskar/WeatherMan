      ...
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              CatppuccinLatteTheme.sky.withValues(alpha: 0.2),
              CatppuccinLatteTheme.lavender.withValues(alpha: 0.2),
              CatppuccinLatteTheme.pink.withValues(alpha: 0.15),
              CatppuccinLatteTheme.base,
            ],
                  ...
                  children: [
                      ...
                      child: Stack(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              gradient: RadialGradient(
                                colors: [
                                  CatppuccinLatteTheme.lavender.withValues(
                                    alpha: 0.15,
                                  ),
                                  CatppuccinLatteTheme.lavender.withValues(
                                    alpha: 0.0,
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: CatppuccinLatteTheme.base.withValues(
                                alpha: 0.9,
                              ),
                              shape: BoxShape.circle,
                              boxShadow: [
                                BoxShadow(
                                  color: CatppuccinLatteTheme.lavender
                                      .withValues(alpha: 0.3),
                                  blurRadius: 30,
                                  spreadRadius: 8,
                                ),
                                BoxShadow(
                                  color: CatppuccinLatteTheme.pink.withValues(
                                    alpha: 0.15,
                                  ),
                                  blurRadius: 40,
                                  spreadRadius: 12,
                          ...
                          Positioned(
                            ...
                            child: AnimatedBuilder(
                              ...
                              child: Icon(
                                Icons.favorite,
                                size: 16,
                                color: CatppuccinLatteTheme.pink,
                              ),
                            ),
                          ),
                        ],
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        ...
                        color: CatppuccinLatteTheme.text,
                        letterSpacing: 1,
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: 14,
                        color: CatppuccinLatteTheme.subtext0,
                    ...
                    AnimatedBuilder(
                      ...
                      builder: (context, child) {
                        return Container(
                          ...
                          height: 8,
                          decoration: BoxDecoration(
                            color: CatppuccinLatteTheme.surface0,
